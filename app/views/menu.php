...
<head>
	...
	<link rel="stylesheet" href="<?php echo base_url()?>res/css/animate.min.css">
	<link rel="stylesheet" href="<?php echo base_url()?>res/css/owl.carousel.min.css">
	<link rel="stylesheet" href="<?php echo base_url()?>res/css/owl.theme.default.min.css">
	<link rel="stylesheet" href="<?php echo base_url()?>res/css/jquery.fancybox.min.css">
	<link rel="stylesheet" href="<?php echo base_url()?>res/fonts/icomoon/style.css">
	<link rel="stylesheet" href="<?php echo base_url()?>res/fonts/flaticon/font/flaticon.css">
	<link rel="stylesheet" href="<?php echo base_url()?>res/css/aos.css">
...
<body>
	...
	<nav class="site-nav mb-5">
		<div class="container-fluid">
			<div class="site-navigation text-center">
				<a href="index.html" class="logo menu-absolute m-0">Meal<span class="text-primary">.</span></a>
	...
	<div class="untree_co-hero overlay" style="background-image: url('<?php echo base_url()?>res/images/hero_bg.jpg');">
		<div class="container">
					...
					<div class="row justify-content-center">
						<div class="col-lg-6 text-center">
							...
							<div class="mb-4 text-white desc" data-aos="fade-up" data-aos-delay="200">
								<p>Another free template by <a href="#" target="_blank" class="link-highlight">Colorlib</a>. Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
							</div>
			...
			<div class="row">
				<div class="col-lg-3 text-center text-lg-left" data-aos="fade-up" data-aos-delay="0">
					...
					<ul class="list-unstyled untree_co-tab-nav js-custom-dots">
						<li class="active"><a href="#" class="d-flex align-items-center"> <img src="<?php echo base_url()?>res/images/1x/noodles.png" alt="Image" class="img-fluid"> <span>Breakfast</span></a></li>
						<li><a href="#" class="d-flex align-items-center"> <img src="<?php echo base_url()?>res/images/1x/chicken.png" alt="Image" class="img-fluid"> <span>Lunch</span></a></li>
						<li><a href="#" class="d-flex align-items-center"> <img src="<?php echo base_url()?>res/images/1x/hotdog.png" alt="Image" class="img-fluid"> <span>Dinner</span></a></li>
						<li><a href="#" class="d-flex align-items-center"> <img src="<?php echo base_url()?>res/images/1x/drinks.png" alt="Image" class="img-fluid"> <span>Drinks</span></a></li>
					</ul>
				</div>
					...
					<div class="owl-single no-dots owl-carousel">
						<div class="item">
							...
							<div class="row">
								<div class="col-6 col-lg-6 mb-4">
									<div class="product">
										<a href="#" class="thumbnail"><img src="<?php echo base_url()?>res/images/img_1.jpg" alt="Image" class="img-fluid"></a>
								...
								<div class="col-6 col-lg-6 mb-4">
									<div class="product">
										<a href="#" class="thumbnail"><img src="<?php echo base_url()?>res/images/img_2.jpg" alt="Image" class="img-fluid"></a>
								...
								<div class="col-6 col-lg-6 mb-0">
									<div class="product">
										<a href="#" class="thumbnail"><img src="<?php echo base_url()?>res/images/img_3.jpg" alt="Image" class="img-fluid"></a>
								...
								<div class="col-6 col-lg-6 mb-0">
									<div class="product">
										<a href="#" class="thumbnail"><img src="<?php echo base_url()?>res/images/img_4.jpg" alt="Image" class="img-fluid"></a>
						...
						<div class="item">
							...
							<div class="row">
								<div class="col-6 col-lg-6 mb-4">
									<div class="product">
										<a href="#" class="thumbnail"><img src="<?php echo base_url()?>res/images/img_1_b.jpg" alt="Image" class="img-fluid"></a>
										<h3><a href="#">Italian Sauce Mushroom</a></h3>
										<div class="d-flex">
											<div class="price">$19.00</div>
										</div>
								...
								<div class="col-6 col-lg-6 mb-4">
									<div class="product">
										<a href="#" class="thumbnail"><img src="<?php echo base_url()?>res/images/img_2_b.jpg" alt="Image" class="img-fluid"></a>
										<h3><a href="#">Salted Fried Chicken</a></h3>
										<div class="d-flex">
											<div class="price">$19.00</div>
										</div>
								...
								<div class="col-6 col-lg-6 mb-0">
									<div class="product">
										<a href="#" class="thumbnail"><img src="<?php echo base_url()?>res/images/img_3_b.jpg" alt="Image" class="img-fluid"></a>
										<h3><a href="#">Fried Potato w/ Garlic</a></h3>
										<div class="d-flex">
											<div class="price">$19.00</div>
										</div>
								...
								<div class="col-6 col-lg-6 mb-0">
									<div class="product">
										<a href="#" class="thumbnail"><img src="<?php echo base_url()?>res/images/img_4_b.jpg" alt="Image" class="img-fluid"></a>
										<h3><a href="#">Shrimp and olive</a></h3>
										<div class="d-flex">
											<div class="price">$19.00</div>
										</div>
						...
						<div class="item">
							...
							<div class="row">
								<div class="col-6 col-lg-6 mb-4">
									<div class="product">
										<a href="#" class="thumbnail"><img src="<?php echo base_url()?>res/images/img_1_d.jpg" alt="Image" class="img-fluid"></a>
										<h3><a href="#">Italian Sauce Mushroom</a></h3>
										<div class="d-flex">
											<div class="price">$19.00</div>
										</div>
								...
								<div class="col-6 col-lg-6 mb-4">
									<div class="product">
										<a href="#" class="thumbnail"><img src="<?php echo base_url()?>res/images/img_2_d.jpg" alt="Image" class="img-fluid"></a>
										<h3><a href="#">Salted Fried Chicken</a></h3>
										<div class="d-flex">
											<div class="price">$19.00</div>
										</div>
								...
								<div class="col-6 col-lg-6 mb-0">
									<div class="product">
										<a href="#" class="thumbnail"><img src="<?php echo base_url()?>res/images/img_3_d.jpg" alt="Image" class="img-fluid"></a>
										<h3><a href="#">Fried Potato w/ Garlic</a></h3>
										<div class="d-flex">
											<div class="price">$19.00</div>
										</div>
								...
								<div class="col-6 col-lg-6 mb-0">
									<div class="product">
										<a href="#" class="thumbnail"><img src="<?php echo base_url()?>res/images/img_4_d.jpg" alt="Image" class="img-fluid"></a>
										<h3><a href="#">Shrimp and olive</a></h3>
										<div class="d-flex">
											<div class="price">$19.00</div>
										</div>
			...
			<div class="row align-items-stretch">
				<div class="col-6 col-lg-3 mb-4 mb-lg-0" data-aos="fade-up" data-aos-delay="0">
					<a href="#" class="d-flex dess-item align-items-center h-100">
						<figure class="mr-3">
							<img src="<?php echo base_url()?>res/images/1x/dessert_1.png" alt="Image" class="img-fluid">
						</figure>
						<div>
							<h3>Cherry Muffin</h3>
				...
				<div class="col-6 col-lg-3 mb-4 mb-lg-0" data-aos="fade-up" data-aos-delay="100">
					<a href="#" class="d-flex dess-item align-items-center h-100">
						<figure class="mr-3">
							<img src="<?php echo base_url()?>res/images/1x/dessert_2.png" alt="Image" class="img-fluid">
						</figure>
						<div>
							<h3>Rose Muffin</h3>
							<span class="price">$20</span>
				...
				<div class="col-6 col-lg-3 mb-4 mb-lg-0" data-aos="fade-up" data-aos-delay="200">
					<a href="#" class="d-flex dess-item align-items-center h-100">
						<figure class="mr-3">
							<img src="<?php echo base_url()?>res/images/1x/dessert_5.png" alt="Image" class="img-fluid">
						</figure>
						<div>
							<h3>Sweet Donut</h3>
							<span class="price">$20</span>
				...
				<div class="col-6 col-lg-3 mb-4 mb-lg-0" data-aos="fade-up" data-aos-delay="300">
					<a href="#" class="d-flex dess-item align-items-center h-100">
						<figure class="mr-3">
							<img src="<?php echo base_url()?>res/images/1x/dessert_4.png" alt="Image" class="img-fluid">
						</figure>
						<div>
							<h3>Choco Cake</h3>
							<span class="price">$20</span>
	...
	<div class="untree_co-section bg-img fixed overlay" style="background-image: url('<?php echo base_url()?>res/images/hero_bg_2.jpg');">
		<div class="container">
			<div class="row">
					...
					<div class="owl-carousel wide-slider-testimonial">
						<div class="item">
							<blockquote class="block-testimonial">
								<div class="author">
									<img src="<?php echo base_url()?>res/images/person_1.jpg" alt="Free template by TemplateUX">
									<h3>John Doe</h3>
						...
						<div class="item">
							<blockquote class="block-testimonial">
								<div class="author">
									<img src="<?php echo base_url()?>res/images/person_2.jpg" alt="Free template by TemplateUX">
						...
						<div class="item">
							<blockquote class="block-testimonial">
								<div class="author">
									<img src="<?php echo base_url()?>res/images/person_3.jpg" alt="Free template by TemplateUX">
									<h3>Rob Smith</h3>
				...
				<div class="col-lg-6 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="100">
					...
					<div class="row">
						<div class="col-6 mb-4">
							<a href="<?php echo base_url()?>res/images/img_1.jpg" data-fancybox="gallery" class="gal"><img src="images/img_1.jpg" alt="Image" class="img-fluid"></a>
						</div>
						<div class="col-6 mb-4">
							<a href="<?php echo base_url()?>res/images/img_2.jpg" data-fancybox="gallery" class="gal"><img src="images/img_2.jpg" alt="Image" class="img-fluid"></a>
						</div>
						<div class="col-6 mb-4">
							<a href="<?php echo base_url()?>res/images/img_1_b.jpg" data-fancybox="gallery" class="gal"><img src="images/img_1_b.jpg" alt="Image" class="img-fluid"></a>
						</div>
						<div class="col-6 mb-4">
							<a href="<?php echo base_url()?>res/images/img_2_b.jpg" data-fancybox="gallery" class="gal"><img src="images/img_2_b.jpg" alt="Image" class="img-fluid"></a>
						</div>
						<div class="col-12">
		...
		<div class="container">
			...
			<div class="events-slider owl-carousel" data-aos="fade-up" data-aos-delay="100">
				<div class="row align-items-center justify-content-between">
					<div class="col-lg-6">
						<img src="<?php echo base_url()?>res/images/party_1.jpg" alt="Image" class="img-fluid">
					</div>
					<div class="col-lg-5">
				...
				<div class="row align-items-center justify-content-between">
					<div class="col-lg-6 order-lg-2">
						<img src="<?php echo base_url()?>res/images/party_2.jpg" alt="Image" class="img-fluid">
					</div>
					<div class="col-lg-5">
						<span class="event-price d-block">$200.99</span>
	...
	<div class="untree_co-section bg-img py-5 fixed overlay" style="background-image: url('<?php echo base_url()?>res/images/hero_bg_2.jpg');">
		<div class="container">
			<div class="row justify-content-center">
				...
				<div class="col-lg-3">
					<div class="widget">
						...
						<ul class="list-unstyled links mb-4">
							<li><a href="#">+254 795 974 284</a></li>
			...
			<div class="row mt-5">
				<div class="col-12 text-center">
					<p>
						...
						Copyright &copy;<script data-cfasync="false" src="../../cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="icon-heart text-danger" aria-hidden="true"></i> by <a href="#" target="_blank">Ancent</a>
					</p>
				</div>
			</div>
		</div> 
	...
	<script src="<?php echo base_url()?>res/js/jquery-3.4.1.min.js"></script>
	...
	<script src="<?php echo base_url()?>res/js/jquery.animateNumber.min.js"></script>
	<script src="<?php echo base_url()?>res/js/jquery.waypoints.min.js"></script>
	<script src="<?php echo base_url()?>res/js/jquery.fancybox.min.js"></script>
	<script src="<?php echo base_url()?>res/js/aos.js"></script>
